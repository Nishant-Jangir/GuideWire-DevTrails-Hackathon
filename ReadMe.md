...
2. [Who we're building for](#who-were-building-for)
3. [What GigShield does](#what-gigshield-does)
4. [How it works end to end](#how-it-works-end-to-end)
5. [The weekly premium model](#the-weekly-premium-model)
6. [The five triggers](#the-five-triggers)
7. [What the claim experience looks like](#what-the-claim-experience-looks-like)
8. [Fraud detection](#fraud-detection)
9. [Adversarial Defense \& Anti-Spoofing Strategy](#adversarial-defense--anti-spoofing-strategy)
10. [Where AI and ML actually fit in](#where-ai-and-ml-actually-fit-in)
11. [Why web, not mobile](#why-web-not-mobile)
...
**Zone risk score** — we maintain historical disruption frequency data by zone. How often does Dharavi flood? How bad does Andheri East get during monsoon? Workers in historically low-risk zones pay up to ₹15 less. Workers in high-risk zones pay at or slightly above the base rate.

**Predictive weather index** — the ML model pulls a 7-day forecast on Sunday evening and runs it through a probability calculation: what's the likelihood of a trigger-level event occurring in this worker's zone next week? If the probability clears 60%, the premium adjusts upward. If it's going to be a clear week in February, they pay less. This is the part where AI genuinely earns its place — not just historical data but a forward-looking adjustment.

**Tenure discount** — workers who've been on the platform for 3+ months with no fraudulent claims get a progressive discount, up to ₹8/week after 6 months. Rewards honest long-term users, discourages people from signing up only when rain is forecast.

**Two examples, same worker:**

Arjun, Standard tier, Koramangala zone, February clear week, 22 months tenure:
₹59 − ₹4 (zone) − ₹7 (clear forecast) − ₹8 (tenure) = **₹40 that week**

Same Arjun, monsoon week in August:
₹59 + ₹6 (monsoon zone risk) + ₹10 (>60% trigger probability) − ₹8 (tenure) = **₹67 that week**
...
> \*"koramangala, hsr, sometimes jayanagar"\*
...
Conversational setup via Claude API
  → Platform (Swiggy / Zomato / both)
  → Primary zones (2–3 areas)
  → Typical working hours
  → UPI ID for payouts
AI builds risk profile → premium quoted
Worker picks tier (Basic / Standard / Premium)
Pays first week via Razorpay
Policy active from next Monday 00:00
```
...
* \[ ] Database schema / ERD
* \[ ] Figma wireframes — worker app + admin dashboard
* \[ ] Project scaffolding — React frontend + Express backend

**Deliverable:** This README + GitHub repo + 2-min video
...
*Guidewire DEVTrails 2026 · Phase 1 · March 2026*
